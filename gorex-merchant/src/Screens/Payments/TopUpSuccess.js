...
const TopUpSuccess = () => {
  ...
  return (
    <View style={styles.container}>
      <BackHeader title={"Wallet Top-up"} />
      ...
      <View style={styles.paddedContent}>
        <View style={styles.paymentContainer}>
          <Image
            ...
            source={TopSuccess}
          />
          <Text style={styles.price}>{t("common.top-up-success")}</Text>
          <Text style={styles.paymentTitle}>{t("common.yourBalance")}</Text>
        </View>
      </View>
      <Footer
        title={t("common.done")}
